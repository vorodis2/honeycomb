...
export class Honeycomb  {
    constructor(textLink, fun, paramScane) {
        ...
        var visi3D = new MVisi3D(this.div, null, this.mobile, true, true, true, true, true);       
        visi3D.yes3d = true;        
...
export class HScane  {
    constructor(par) {
        ...
        this.getCombForId=function(value){
...
export class Comb  {
    constructor(par, c3d) {
        ...
        this.idRandom=""+Math.round(Math.random()*1000000);
        this._idArray ='';
